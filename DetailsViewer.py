...
The following key bindings can be used as accelerators.  Note that ColourAll can
...

class DetailsViewer:
    def __init__(self, switchboard, master=None, sa=1):
        ...
        root.title('ColourAll Details Window')
        root.iconname('ColourAll Details Window')
