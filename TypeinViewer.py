...
The TypeinViewer is what you see at the lower right of the main ColourAll
...
values that are legal for a colour axis.  This usually means 0-255 for decimal
...
colour selection will be made on every change to the text field.  Otherwise,
you must hit Return or Tab to select the colour.
"""
...
class TypeinViewer:
    def __init__(self, switchboard, master=None, sa=0):
        ...
        self.__xox = Label(subframe, text='  ')
        ...
        self.__yox = Label(subframe, text='  ')
        ...
        self.__zox = Label(subframe, text='  ')
        ...
        self.__togglehex() #Update the 0x-or-no-0x
    ...
    def __normalize(self, event=None):
        ...
        if v is None:
            ...
            if event.char:
                ...
                icursor = icursor - 1 #Was "icurser" on the right
            ew.bell()
    ...
    def __update(self, event=None):
        ...
        if self.__hexp.get():
            ...
            base = 10
        red, green, blue = map(lambda x,base=base:int(x, base),(redstr, greenstr, bluestr))
        self.__sb.update_views(red, green, blue)

    def update_yourself(self, red, green, blue):
        if self.__hexp.get():
            sred, sgreen, sblue = map(lambda x:hex(x)[2:],(red, green, blue))
        else:
